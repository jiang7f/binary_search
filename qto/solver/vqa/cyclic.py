...
from .option import LayerCircuitOption, OptimizerOption
...
from .circuit_decompose.circuit_components import obj_compnt, cyclic_compnt, penalty_decompose


class CyclicCircuit(VqaCircuit[LayerCircuitOption]):
