...
from .circuit_decompose.circuit_components import obj_compnt, commute_compnt, penalty_decompose


class PenaltyCircuit(VqaCircuit[LayerCircuitOption]):
